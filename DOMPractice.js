...
for(let i of childDiv){
i.style.width = "100%"
i.style.height = "50px"
i.style.backgroundColor = "blue"
i.style.margin = "30px 0px"
i.style.textAlign = "center"
i.style.color = "#E0D635"
}
let count = 1
const grandchildDiv = document.querySelectorAll('.grandchild')
for(let i of grandchildDiv){
    i.style.width = "100%"
    i.style.height = "7px"
    i.innerHTML = count
...
childDiv[4].children[1].style.color = 'pink'
childDiv[4].children[1].style.fontStyle = 'italicize'
const blackSheep = childDiv[2].children[2]
childDiv[2].style.position = 'relative'
